...
@section('content')
    <div class="row mb-4">
        ...
        <x-adminlte-info-box
            ...
            theme="warning"
            class="col-md-4"
            progress="{{ $messageGrowth }}%"
            progress-description="Non lus: {{ $unreadMessages }}"
        />
        ...
        <x-adminlte-info-box
            ...
            theme="teal"
            class="col-md-4"
            progress="{{ $availableCouriersPercentage }}%"
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <span class="badge badge-danger">{{ $recentOrders->count() }} nouvelles</span>
                    </div>
                </div>
